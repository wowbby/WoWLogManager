...
@implementation WoWLogManager
+ (WoWLogManager *)shareManager
{
    static WoWLogManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
      manager = [[WoWLogManager alloc] init];
...
{
    // 1.自定义Log格式
    WoWLogFormatter *logFormatter = [[WoWLogFormatter alloc] init];
    ...
    DDFileLogger *fileLogger = [WoWLogManager shareManager].fileLogger;
